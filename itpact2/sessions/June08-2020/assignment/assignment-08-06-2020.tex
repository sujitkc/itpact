...
\author{}
\title{ITPACT \\ Assignment June 08, 2020}
...
\begin{questions}
\question Write a program that prints all elements of a list in the same order.

  (\textbf{\color{BrickRed}File:} \kctt{print_list.py})

\question Write a program that prints all elements of a list in reverse order.

  (\textbf{\color{BrickRed}File:} \kctt{print_rev_list.py})

\question Write a program that computes and prints the product of all elements of a list.
...
\question Write a program that finds and prints the maximum element in a list.
