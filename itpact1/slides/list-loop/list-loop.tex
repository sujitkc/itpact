...
\\
\begin{tikzpicture}
\node[circle, draw=none, fill=none, minimum height=1cm] {};
\end{tikzpicture}
& & & & 
\\
\begin{tikzpicture}
\node[rectangle, draw=Red, fill=Red, minimum height=0.5cm, minimum width=0.5cm] {};
\end{tikzpicture}
& & & & 
\end{tabular}
...
\\
\begin{tikzpicture}
\node[circle, draw=Red, fill=Red, minimum height=1cm] {};
\end{tikzpicture}
& & & & 
\end{tabular}
